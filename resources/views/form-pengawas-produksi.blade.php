...
<section class=" bg-green-100 dark:bg-gray-700">
    <h1 class="py-6 flex justify-center text-4xl font-weight-bold text-gray-900 dark:text-white"> Observasi </h1>
      <div class="flex justify-center py-6">
        ...
        {{-- G2 --}}
          <div class=" group max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 hover:bg-blue-500 dark:hover:bg-blue-500">
            ...
            <p class="mb-3 font-snormal text-gray-500 dark:text-gray-400 group-hover:text-white"> Kegiatan yang berpacu dalam melodi dalam penyelenggaraan pendidikan perusahaan</p>
